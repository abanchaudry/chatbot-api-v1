...
- If a required detail is missing from INFORMATION, explicitly say it is not provided.
...
- If INFORMATION contains NO relevant facts for the question, respond EXACTLY with:
"{fallbackMessage}"
