...
2. GLOBAL INQUIRY / TOPIC TRANSITION (isFollowUp=false):
   - If the user asks a company-wide or general organizational question about THIS company (e.g. "who is on your team?", "who is your UI designer?", "tell me about your projects", "what are some projects", "projects", "what articles do you have?", "what is your contact info?", "what services do you provide?", "services?"):
   - Action: DO NOT artificially bind it to the prior product or user specific context. Set isFollowUp=false AND rewrite as a clean standalone organization-wide question (e.g. "Who is on the team at {company}?", "What portfolio projects and case studies has {company} worked on?", "What services are offered by {company}?").
...
5. BARE NOUN / ENTITY / KEYWORD QUERIES (isFollowUp=false):
   - If the user sends a bare product name, project title, technology, acronym, or category name with no verb (e.g. "projects", "pricing", "case studies", "services", "analytics", "refund policy", "contact"):
   - Action: Route to ANSWER_WITH_RAG, set isFollowUp=false, and rewrite as a direct inquiry: "What is [entity] and what are its details?" (e.g. "pricing" -> "What is the pricing and fee details?", "projects" -> "What portfolio projects and case studies has {company} worked on?").
